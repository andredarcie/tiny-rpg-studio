...
const TEXT_BUNDLES = {
    'pt-BR': {
        ...
        'project.group.appearance': 'Aparência',
        'project.group.info': 'Informações',
        'project.group.export': 'Exportação',
        ...
        'objects.category.swords': 'Espadas',
        ...
        'skills.stealth.desc': 'Sempre ataca primeiro contra inimigos fracos (3 vidas ou menos).',
    ...
    'en-US': {
        ...
        'project.group.appearance': 'Appearance',
        'project.group.info': 'Information',
        'project.group.export': 'Export',
        ...
        'objects.category.swords': 'Swords',
        ...
        'skills.stealth.desc': 'Always attack first against weak enemies (3 lives or less).',
