    ...
    static ENEMY_DEFINITION_DATA: EnemyDefinitionData[] = [
        {
            ...
            descriptionKey: 'enemies.desc.giantRat',
            lives: 1,
            damage: 1,
            missChance: 0.10,
            experience: 3,
        ...
        },
        {
            ...
            descriptionKey: 'enemies.desc.bandit',
            lives: 2,
            damage: 1,
            missChance: 0.25,
            experience: 4,
        ...
        },
        {
            ...
            descriptionKey: 'enemies.desc.skeleton',
            lives: 3,
            damage: 1,
            missChance: 0.25,
            experience: 5,
        ...
        },
        {
            ...
            descriptionKey: 'enemies.desc.darkKnight',
            lives: 4,
            damage: 2,
            missChance: 0.18,
            experience: 7,
        ...
        },
        {
            ...
            descriptionKey: 'enemies.desc.necromancer',
            lives: 5,
            damage: 2,
            missChance: 0.12,
            experience: 8,
        ...
        },
        {
            ...
            descriptionKey: 'enemies.desc.dragon',
            lives: 6,
            damage: 3,
            missChance: 0.08,
        ...
        },
        {
            ...
            descriptionKey: 'enemies.desc.fallenKing',
            lives: 7,
            damage: 3,
            missChance: 0.08,
        ...
        },
        {
            ...
            descriptionKey: 'enemies.desc.ancientDemon',
            lives: 8,
            damage: 3,
            missChance: 0.05,
