...
class ExploreModal {
  ...
  close(): void {
    ...
    // Discard pending previews — modal is closed, no point rendering them
    this.previewQueue = [];
  }
  ...
  private renderCard(game: GameEntry): HTMLElement {
    ...
    if (game.coverImage) {
      ...
      // Placeholder shown immediately; preview rendered async
  ...
  private processNextPreview(): void {
    ...
    requestAnimationFrame(() => {
      ...
      // Remove placeholder spinner once image is ready
